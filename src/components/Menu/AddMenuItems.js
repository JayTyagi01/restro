              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 ">
                <div>
                  <div className="card w-44 h-100 text-white shadow-xl bg-black bg-opacity-40">
                    <figure><img src="https://www.thespruceeats.com/thmb/XDBL9gA6A6nYWUdsRZ3QwH084rk=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/SES-chicken-biryani-recipe-7367850-hero-A-ed211926bb0e4ca1be510695c15ce111.jpg" alt="Food" /></figure>
                ...
                <div>
                  <div className="card w-44 h-100 text-white shadow-xl bg-black bg-opacity-40">
                    <figure><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRx_K5aV-nTGQHPeAGKTpcLUewc4asM1Klnks65IVT2npSPx1k1RVOp3zY_GY_HjKyiXO0&usqp=CAU" alt="Food" /></figure>
                    <div className="card-body items-center text-center">
                      <h2 className="card-title">
                        Tomato Rasam
